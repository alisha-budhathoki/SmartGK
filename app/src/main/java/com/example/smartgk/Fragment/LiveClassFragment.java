...
public class LiveClassFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_licvclass, container, false);

        webView = rootView.findViewById(R.id.liveWebView);
        final ProgressBar progressBar1 = rootView.findViewById(R.id.progressBarLiv);
